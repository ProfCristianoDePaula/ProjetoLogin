    ...
    public partial class tipo : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0b996c66-3d97-46fd-8d8a-9bbd1115e4cf", null, "Professor", "PROFESSOR" },
                    { "3a6cc1e1-67a9-4f15-af28-ed89598c57e7", null, "Coordenador", "COORDENADOR" },
                    { "50fec709-9561-42b9-8f04-04aeabf28f2f", null, "Psicólogo", "PSICÓLOGO" },
                    { "90ee0b92-3fd3-4afd-9c5b-7295a7657352", null, "Admin", "ADMIN" },
                    { "b0743f09-e661-4371-b6e4-3aa3bdb07cc1", null, "Operador", "OPERADOR" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "0ab699fd-bee7-4968-8994-c478bc7fbbf4", 0, "dd32a00d-a45a-444b-ba0a-3be8f9143c52", "admin@admin.com", true, false, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAIAAYagAAAAELeDKkrL854efnq6mzWcNtCEYW0X4ZwZAHJrA1URpgeAAqWhX/x3cLsCMsviS3LiEw==", null, false, "f8bc5daf-3c67-464c-82a6-bf64ee65828f", false, "admin@admin.com" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "90ee0b92-3fd3-4afd-9c5b-7295a7657352", "0ab699fd-bee7-4968-8994-c478bc7fbbf4" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "0b996c66-3d97-46fd-8d8a-9bbd1115e4cf");

            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "3a6cc1e1-67a9-4f15-af28-ed89598c57e7");

            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "50fec709-9561-42b9-8f04-04aeabf28f2f");

            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "b0743f09-e661-4371-b6e4-3aa3bdb07cc1");

            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "RoleId", "UserId" },
                keyValues: new object[] { "90ee0b92-3fd3-4afd-9c5b-7295a7657352", "0ab699fd-bee7-4968-8994-c478bc7fbbf4" });

            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "90ee0b92-3fd3-4afd-9c5b-7295a7657352");

            migrationBuilder.DeleteData(
                table: "AspNetUsers",
                keyColumn: "Id",
                keyValue: "0ab699fd-bee7-4968-8994-c478bc7fbbf4");
